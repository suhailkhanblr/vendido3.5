...
class AppSetting extends PsObject<AppSetting?> {
  AppSetting({this.latitude, this.longitude, this.isSubLocation, this.isBlockedDisabled, this.isPaidApp,this.isSubCatSubscribe, this.maxImageCount,this.adType,this.promoCellNo});
  String? latitude;
  String? longitude;
