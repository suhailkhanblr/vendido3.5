      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          iconTheme: Theme.of(context)
              .iconTheme
              .copyWith(color: PsColors.activeColor),//Utils.isLightMode(context)? PsColors.primary500 : PsColors.primaryDarkWhite),
          title: Text(
            widget.userName,
            ...
            style: Theme.of(context)
                .textTheme
                .headline6!
                .copyWith(color: PsColors.activeColor, fontWeight: FontWeight.bold),
          ),
          elevation: 0,
        ),
        body: Container(
