...
class PSButtonWidgetWithIconRoundCorner extends StatefulWidget {
  ...
  @override
  _PSButtonWidgetWithIconRoundCornerState createState() => _PSButtonWidgetWithIconRoundCornerState();
}

class _PSButtonWidgetWithIconRoundCornerState extends State<PSButtonWidgetWithIconRoundCorner> {
  Gradient? _gradient;
  Color? _color;
  Color? _iconColor;
            ...
            children: <Widget>[
             ...
             Text(
                  ...
                  style: Theme.of(context)
                      ...
                      .bodyText2!
                      .copyWith(color: 
                        widget.titleText  ==  Utils.getString(context, 'edit_profile__title') || widget.titleText  ==  Utils.getString(context, 'Reset')
                        || widget.titleText  == Utils.getString(context, 'map_filter__reset')
