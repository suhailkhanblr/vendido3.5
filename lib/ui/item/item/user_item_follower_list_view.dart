...
class UserItemFollowerListView extends StatefulWidget {
  const UserItemFollowerListView({required this.loginUserId, required this.holder});
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        itemListFromFollowersProvider
            .nextItemListFromFollowersList(itemListFromFollowersProvider.followUserItemParameterHolder.toMap(),widget.loginUserId);
      }
    });
  }
    ...
    return WillPopScope(
      ...
      child: PsWidgetWithAppBar<ItemListFromFollowersProvider>(
          ...
          onProviderReady: (ItemListFromFollowersProvider? provider) {
            ...
            provider.loadItemListFromFollowersList(provider.followUserItemParameterHolder.toMap(),loginUserId);
              ...
              child: Stack(children: <Widget>[
                Container(
                    ...
                    child: RefreshIndicator(
                      ...
                      onRefresh: () async {
                        return itemListFromFollowersProvider
                            .resetItemListFromFollowersList(itemListFromFollowersProvider.followUserItemParameterHolder.toMap(),widget.loginUserId);
                      },
                    )),
