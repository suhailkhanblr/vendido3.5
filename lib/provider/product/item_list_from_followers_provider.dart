...
class ItemListFromFollowersProvider extends PsProvider {
  ...
  Future<dynamic> loadItemListFromFollowersList(  Map<dynamic, dynamic> jsonMap,String? loginUserId) async {
    isLoading = true;
  ...
  Future<dynamic> nextItemListFromFollowersList(Map<dynamic, dynamic> jsonMap,String loginUserId) async {
    isConnectedToInternet = await Utils.checkInternetConnectivity();
  ...
  Future<void> resetItemListFromFollowersList(Map<dynamic, dynamic> jsonMap,String? loginUserId) async {
    isConnectedToInternet = await Utils.checkInternetConnectivity();
    isLoading = true;
